...
const cards: DashboardCard[] = [
  ...
  // },
  {
    ...
    link: ['/projects/planet-generator', 'https://github.com/tpurcell-frontend/Portfolio/blob/main/src/pages/PlanetGenerator.tsx'],
  ...
  },
  {
    ...
    footer: ['See the Project', 'See the Repo'],
    link: ['/projects/todo-list', 'https://github.com/tpurcell-frontend/Portfolio/blob/main/src/pages/ToDoList.tsx'],
    width: `calc(33.33% - 8px)`,
    project: true,
    blank: true,
    filter: 'Projects',
